		...
		<Card dis-hover>
			...
			<Form ref="form" :model="form" inline :label-width="80">
				<FormItem prop="userCode" label="工号：">
					<Input type="text" v-model="form.userCode" placeholder="请输入工号" style="width: 180px" />
				</FormItem>
				<FormItem prop="userName" label="姓名：">
					<Input type="text" v-model="form.userName" placeholder="请输入姓名" style="width: 180px" />
				</FormItem>
				<FormItem prop="labelName" label="部门：">
					<Input type="text" v-model="form.roleName" placeholder="请选择部门" icon="ios-clock-outline" style="width: 180px" />
				</FormItem>
				<FormItem prop="availableStatus" label="在职状态：">
					<Select v-model="form.availableStatus" style="width: 180px">
				...
				<FormItem prop="accountStatus" label="账号状态：">
					<Select v-model="form.accountStatus" style="width: 180px">
                		<Option value="">全部</Option>
		...
		<Card dis-hover>
			...
			<div slot="extra">
				<div class="btn-group">
					...
					<Button type="primary" style="float: right;" @click="openDialog('add')">新增</Button>
...
//                  						vm.$emit('input', params.tableData.filter((item, index) => index !== params.row.initRowIndex))
				...
				tableData: {
					list: [
						{userCode: "001", userName: "丁志龙",loginName:"admin",sex:0,availableStatus:0,accountStatus:0,mobile:'15623658965'},
						{userCode: "001", userName: "丁志龙",loginName:"admin",sex:0,availableStatus:0,accountStatus:0,mobile:'15623658965'},
					],
					total: 0,
					pageNum: 1,
